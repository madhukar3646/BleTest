...
public class BleServicesActivity extends AppCompatActivity {
    ...
    private String ble_name,ble_mac;
    ...
    private void init()
    {
        ...
        bleServicesAdapter=new BleServicesAdapter(BleServicesActivity.this,serviceslist);
        ...
        if(mBluetoothAdapter==null) {
            ...
            Toast.makeText(BleServicesActivity.this,"Device not supported",Toast.LENGTH_SHORT).show();
            finish();
        }
        if (dialog == null)
            dialog = new Dialog(BleServicesActivity.this,
        ...
        lv_serviceslist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent1=new Intent(BleServicesActivity.this,SubServicesActivity.class);
                intent1.putExtra("BLE_NAME",ble_name);
                intent1.putExtra("BLE_MAC_ADDRESS",ble_mac);
                intent1.putExtra("SERVICE_ID",serviceslist.get(i));
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                for (int i = 0; i < services.size(); i++) {
                    ...
                    serviceslist.add(uuid.toString());
                }
